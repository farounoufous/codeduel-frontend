...
//   { texte: "Quelle valeur de `display` rend un élément invisible mais conserve son espace ?", choix: ["none", "hidden", "visibility:hidden", "display:hide"], bonne: 2, lang: "CSS" },
//   { texte: "Que fait `box-sizing: border-box;` ?", choix: ["Inclut padding et border dans width/height", "Ajoute une bordure visible", "Supprime le margin", "Change le modèle de font"], bonne: 0, lang: "CSS" },
//   { texte: "Quel sélecteur cible tous les <p> enfants directs d'un <div> ?", choix: ["div p", "div > p", "div + p", "div ~ p"], bonne: 1, lang: "CSS" },
//   { texte: "Quel sélecteur cible le premier enfant de son parent ?", choix: [":first-child", ":first-of-type", "::first", ":nth-child(0)"], bonne: 0, lang: "CSS" },
//   { texte: "Que produit `.box { margin: 10px 20px; }` ?", choix: ["10px haut/bas, 20px gauche/droite", "20px haut/bas, 10px gauche/droite", "10px partout", "20px partout"], bonne: 0, lang: "CSS" },
//   { texte: "Quel code centre un bloc horizontalement ?", choix: ["margin: 0 auto;", "text-align: center;", "align: center;", "display: center;"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `position: relative;` sans top/left ?", choix: ["Ne déplace rien mais crée un contexte de positionnement", "Positionne par rapport au viewport", "Retire l'élément du flux", "Identique à static"], bonne: 0, lang: "CSS" },
//   { texte: "Quelle pseudo-classe s'active au survol ?", choix: [":active", ":hover", ":focus", ":visited"], bonne: 1, lang: "CSS" },
//   { texte: "Quel code crée un Flexbox avec éléments centrés horizontalement ?", choix: ["display:flex; justify-content:center;", "display:flex; align-items:center;", "display:block; margin:auto;", "display:flex; text-align:center;"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `align-items: center` dans un Flexbox en direction row ?", choix: ["Centre sur l'axe horizontal", "Centre sur l'axe vertical", "Centre les deux axes", "Aligne à droite"], bonne: 1, lang: "CSS" },
//   { texte: "Quel code fait un carré bleu de 100px ?", choix: ["width:100px;height:100px;background:blue;", "size:100px;color:blue;", "box:100px blue;", "block:100px;fill:blue;"], bonne: 0, lang: "CSS" },
//   { texte: "Quelle propriété contrôle l'opacité ?", choix: ["opacity", "transparency", "alpha", "visible"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `z-index` ?", choix: ["L'ordre d'empilement", "La taille de la police", "Le niveau de zoom", "La profondeur de shadow"], bonne: 0, lang: "CSS" },
//   { texte: "Quel sélecteur cible un élément avec classe `btn` ET `active` ?", choix: [".btn .active", ".btn+.active", ".btn.active", "btn active"], bonne: 2, lang: "CSS" },
//   { texte: "Que fait `overflow: hidden;` ?", choix: ["Cache le contenu dépassant du conteneur", "Supprime l'élément", "Rend transparent", "Ajoute un scroll"], bonne: 0, lang: "CSS" },
//   { texte: "Quelle unité est relative à la taille de la police de l'élément ?", choix: ["px", "em", "rem", "%"], bonne: 1, lang: "CSS" },
//   { texte: "Quelle unité est toujours relative à la racine <html> ?", choix: ["em", "px", "rem", "vw"], bonne: 2, lang: "CSS" },
//   { texte: "Que vaut `1vw` ?", choix: ["1% de la hauteur du viewport", "1% de la largeur du viewport", "1px", "1% du parent"], bonne: 1, lang: "CSS" },
//   { texte: "Quel code arrondit les coins d'un div ?", choix: ["corner-radius:8px;", "border-curve:8px;", "border-radius:8px;", "round:8px;"], bonne: 2, lang: "CSS" },
//   { texte: "Comment écrire une ombre portée noire floue de 10px ?", choix: ["box-shadow: 0 0 10px rgba(0,0,0,0.5);", "shadow: black 10px;", "drop-shadow: 10px black;", "text-shadow: 0 0 10px;"], bonne: 0, lang: "CSS" },
//   { texte: "Quelle valeur de `position` sort l'élément du flux et se colle au viewport ?", choix: ["relative", "absolute", "fixed", "sticky"], bonne: 2, lang: "CSS" },
//   { texte: "Que fait `position: sticky; top: 0;` ?", choix: ["Se fixe en haut quand on défile jusqu'à lui", "Identique à fixed", "Identique à absolute", "Ne fait rien"], bonne: 0, lang: "CSS" },
//   { texte: "Quel code crée une grille de 3 colonnes égales ?", choix: ["display:grid; grid-template-columns:1fr 1fr 1fr;", "display:grid; columns:3;", "display:grid; grid:3cols;", "flex:3;"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `gap: 16px;` sur un conteneur grid ?", choix: ["Espacement entre les cellules", "Padding intérieur", "Margin extérieur", "Largeur des colonnes"], bonne: 0, lang: "CSS" },
//   { texte: "Quelle propriété définit l'épaisseur de la police ?", choix: ["font-weight", "font-size", "font-style", "text-weight"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `text-transform: uppercase;` ?", choix: ["Met en majuscules", "Met en gras", "Souligne", "Italicise"], bonne: 0, lang: "CSS" },
//   { texte: "Quel code empêche le retour à la ligne ?", choix: ["white-space: nowrap;", "overflow: hidden;", "text-overflow: clip;", "word-break: keep-all;"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `text-overflow: ellipsis;` sans `overflow:hidden` et `white-space:nowrap` ?", choix: ["Rien — les 3 règles sont nécessaires", "Coupe le texte", "Ajoute ... automatiquement", "Réduit la font"], bonne: 0, lang: "CSS" },
//   { texte: "Quel code produit un texte coupé avec … sur une ligne ?", choix: ["white-space:nowrap; overflow:hidden; text-overflow:ellipsis;", "overflow:clip; text:ellipsis;", "cut-text:true;", "truncate:1;"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `cursor: pointer;` ?", choix: ["Affiche la main au survol", "Cache le curseur", "Crée un bouton", "Change la couleur"], bonne: 0, lang: "CSS" },
//   { texte: "Quelle propriété contrôle l'espace entre les lignes de texte ?", choix: ["line-height", "letter-spacing", "word-spacing", "line-spacing"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `transition: all 0.3s ease;` ?", choix: ["Anime toutes les propriétés CSS sur 0.3s", "Change l'opacité", "Décale l'élément", "Crée une animation infinie"], bonne: 0, lang: "CSS" },
//   { texte: "Quel code fait une rotation de 45° d'un élément ?", choix: ["transform: rotate(45deg);", "rotate: 45deg;", "animation: rotate 45;", "position: rotate(45);"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `transform: scale(2);` ?", choix: ["Double la taille visuellement", "Double width et height", "Double le z-index", "Double l'opacité"], bonne: 0, lang: "CSS" },
//   { texte: "Quelle différence entre `translate(10px,0)` et `margin-left:10px` ?", choix: ["translate ne perturbe pas le flux", "margin ne bouge pas", "Aucune différence", "translate est plus lent"], bonne: 0, lang: "CSS" },
//   { texte: "Quelle at-rule crée une animation CSS ?", choix: ["@keyframes", "@animation", "@transition", "@frames"], bonne: 0, lang: "CSS" },
//   { texte: "Quel code fait clignoter un élément indéfiniment ?", choix: ["animation: blink 1s infinite;", "transition: blink 1s loop;", "@keyframes infinite blink;", "animate: loop blink;"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `animation-fill-mode: forwards;` ?", choix: ["L'élément garde l'état final après l'animation", "Revient à l'état initial", "Répète l'animation", "N'a aucun effet"], bonne: 0, lang: "CSS" },
//   { texte: "Comment cibler les éléments pairs d'une liste ?", choix: [":nth-child(even)", ":even", ":nth-child(2)", ":pair"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `:not(.active)` ?", choix: ["Cible tous les éléments sans classe active", "Cible les éléments avec .active", "Cible le parent", "Invalide la règle"], bonne: 0, lang: "CSS" },
//   { texte: "Quel sélecteur cible le dernier <li> d'une liste ?", choix: ["li:last-child", "li:last", "li:nth-last(1)", "last li"], bonne: 0, lang: "CSS" },
//   { texte: "Quelle syntaxe déclare une variable CSS ?", choix: ["--ma-variable: valeur;", "var(--x): valeur;", "$var: valeur;", "@var: valeur;"], bonne: 0, lang: "CSS" },
//   { texte: "Comment utiliser une variable CSS `--primary-color` ?", choix: ["color: var(--primary-color);", "color: $primary-color;", "color: --primary-color;", "color: @primary-color;"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `display: none;` vs `visibility: hidden;` ?", choix: ["none supprime l'espace, hidden le garde", "Aucune différence", "hidden supprime l'espace", "none garde l'espace"], bonne: 0, lang: "CSS" },
//   { texte: "Quel code crée un cercle parfait avec un div de 100px ?", choix: ["width:100px;height:100px;border-radius:50%;", "width:100px;height:100px;round:true;", "circle:100px;", "border:circle;"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `flex-wrap: wrap;` ?", choix: ["Les items passent à la ligne si nécessaire", "Force une seule ligne", "Enroule le conteneur", "Cache le débordement"], bonne: 0, lang: "CSS" },
//   { texte: "Quel code aligne le dernier item Flex à droite ?", choix: ["margin-left: auto; sur le dernier item", "justify-content: flex-end;", "align-self: flex-end;", "float: right;"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `flex: 1;` sur un item flex ?", choix: ["L'item prend tout l'espace disponible", "Réduit la taille", "Fixe la taille à 1px", "Cache l'item"], bonne: 0, lang: "CSS" },
//   { texte: "Quelle Media Query cible les écrans ≤768px ?", choix: ["@media (max-width: 768px)", "@media (min-width: 768px)", "@media screen 768px", "@media <=768px"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `@media print` ?", choix: ["Styles appliqués à l'impression", "Styles pour les gros écrans", "Styles pour les polices", "Styles pour les images"], bonne: 0, lang: "CSS" },
//   { texte: "Quel pseudo-élément insère du contenu avant un élément ?", choix: ["::before", "::after", "::prepend", "::first"], bonne: 0, lang: "CSS" },
//   { texte: "Que nécessite `::before` pour être visible ?", choix: ["La propriété content", "background-color", "display:block", "z-index"], bonne: 0, lang: "CSS" },
//   { texte: "Quel code ajoute un • rouge avant chaque .item ?", choix: [".item::before { content:'•'; color:red; }", "item:before='•' color=red;", ".item { prefix:'•' red; }", "::before .item { •; red; }"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `object-fit: cover;` sur une image ?", choix: ["Remplit le conteneur en rognant l'image", "Étire l'image", "Réduit l'image", "Cache l'image"], bonne: 0, lang: "CSS" },
//   { texte: "Quel code centre absolument un élément dans son parent relatif ?", choix: ["position:absolute; top:50%; left:50%; transform:translate(-50%,-50%);", "position:absolute; margin:auto;", "position:absolute; center:true;", "display:center;"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `pointer-events: none;` ?", choix: ["Désactive les clics sur l'élément", "Cache l'élément", "Supprime le curseur", "Bloque le focus"], bonne: 0, lang: "CSS" },
//   { texte: "Quelle propriété empêche la sélection de texte ?", choix: ["user-select: none;", "select: none;", "text-select: off;", "no-select: true;"], bonne: 0, lang: "CSS" },
//   { texte: "Comment écrire une couleur rouge à 50% d'opacité ?", choix: ["rgba(255,0,0,0.5)", "rgb(255,0,0,50%)", "color(red, 0.5)", "hex(#ff000080)"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `filter: blur(4px);` ?", choix: ["Applique un flou gaussien sur l'élément", "Rend transparent", "Agrandit l'élément", "Grise l'élément"], bonne: 0, lang: "CSS" },
//   { texte: "Quel code crée un dégradé de rouge à bleu horizontalement ?", choix: ["background: linear-gradient(to right, red, blue);", "background: gradient(red, blue);", "background: color-gradient(left, red, blue);", "color: linear(red, blue);"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `background-size: cover;` ?", choix: ["L'image couvre tout le conteneur en rognant", "L'image est répétée", "L'image est à sa taille originale", "L'image est étirée à 100%"], bonne: 0, lang: "CSS" },
//   { texte: "Quelle propriété contrôle la répétition d'un fond ?", choix: ["background-repeat", "background-tile", "background-loop", "background-position"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `outline: none;` sur les boutons ?", choix: ["Supprime le contour de focus", "Supprime la bordure", "Supprime le padding", "Cache le texte"], bonne: 0, lang: "CSS" },
//   { texte: "Quelle est la différence entre `border` et `outline` ?", choix: ["outline ne prend pas d'espace dans le flux", "border est externe", "Aucune différence", "outline est à l'intérieur"], bonne: 0, lang: "CSS" },
//   { texte: "Quel code crée une liste sans puces ?", choix: ["list-style: none;", "bullets: none;", "list-type: hidden;", "ul-style: remove;"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `table-layout: fixed;` ?", choix: ["Colonnes de largeur fixe définie par la première ligne", "Empêche le redimensionnement", "Fixe la hauteur", "Désactive le tableau"], bonne: 0, lang: "CSS" },
//   { texte: "Quel code supprime le soulignement d'un lien ?", choix: ["text-decoration: none;", "underline: off;", "link-style: none;", "a-decor: remove;"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `word-break: break-all;` ?", choix: ["Coupe les mots n'importe où", "Interdit les coupures", "Coupe aux espaces", "Masque le dépassement"], bonne: 0, lang: "CSS" },
//   { texte: "Quelle propriété crée un scroll horizontal sur un conteneur ?", choix: ["overflow-x: auto;", "scroll: horizontal;", "x-overflow: scroll;", "flow: x;"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `resize: none;` sur un <textarea> ?", choix: ["Désactive le redimensionnement", "Cache la scrollbar", "Fixe la hauteur", "Empêche la saisie"], bonne: 0, lang: "CSS" },
//   { texte: "Quel sélecteur cible un input en état invalide ?", choix: [":invalid", ":error", ":bad", ":fail"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `:focus-within` ?", choix: ["S'active si un enfant a le focus", "S'active si l'élément a le focus", "S'active au hover", "S'active au clic"], bonne: 0, lang: "CSS" },
//   { texte: "Quel code crée un aspect-ratio 16/9 sur un div ?", choix: ["aspect-ratio: 16/9;", "ratio: 16:9;", "size-ratio: 16/9;", "dimensions: 16/9;"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `content-visibility: auto;` ?", choix: ["Optimise le rendu en sautant le contenu hors écran", "Cache le contenu", "Anime le contenu", "Crée un contexte de stacking"], bonne: 0, lang: "CSS" },
//   { texte: "Quelle propriété contrôle l'espace entre les caractères ?", choix: ["letter-spacing", "char-spacing", "font-spacing", "text-kerning"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `writing-mode: vertical-rl;` ?", choix: ["Texte vertical de droite à gauche", "Texte vertical de gauche à droite", "Renverse le texte", "Rote le texte 90°"], bonne: 0, lang: "CSS" },
//   { texte: "Quel code masque un élément accessible aux lecteurs d'écran ?", choix: ["position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0,0,0,0);", "display:none;", "visibility:hidden;", "opacity:0;"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `isolation: isolate;` ?", choix: ["Crée un nouveau contexte de stacking", "Isole les styles", "Désactive les mix-blend-mode", "Crée un BFC"], bonne: 0, lang: "CSS" },
//   { texte: "Quel code applique un style uniquement en dark mode ?", choix: ["@media (prefers-color-scheme: dark)", "@media (dark-mode)", "@supports (dark)", "@theme dark"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `clamp(1rem, 2.5vw, 2rem)` dans font-size ?", choix: ["Taille fluide entre 1rem et 2rem", "Fixe la taille à 2.5vw", "Prend le max des 3 valeurs", "Prend le min des 3 valeurs"], bonne: 0, lang: "CSS" },
//   { texte: "Quel code crée 3 colonnes grid avec un gap de 24px ?", choix: ["display:grid; grid-template-columns:repeat(3,1fr); gap:24px;", "display:grid; columns:3; spacing:24px;", "flex:3; gap:24px;", "columns:3; gap:24px;"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `grid-column: 1 / -1;` ?", choix: ["L'item s'étend sur toutes les colonnes", "Positionne en colonne 1 à -1px", "Cache les colonnes", "Crée une colonne négative"], bonne: 0, lang: "CSS" },
//   { texte: "Quel code crée un texte en dégradé ?", choix: ["background:linear-gradient(red,blue); -webkit-background-clip:text; color:transparent;", "color:gradient(red,blue);", "text-gradient:red blue;", "font-color:linear(red,blue);"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `mix-blend-mode: multiply;` ?", choix: ["Mélange l'élément avec son fond en multiplication", "Multiplie la taille", "Répète l'élément", "Assombrit uniquement"], bonne: 0, lang: "CSS" },
//   { texte: "Quel code crée un scroll snap horizontal ?", choix: ["scroll-snap-type:x mandatory; sur le parent + scroll-snap-align:start; sur les enfants", "scroll:snap;", "snap:true;", "scroll-align:snap;"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `will-change: transform;` ?", choix: ["Avertit le navigateur pour optimiser le rendu GPU", "Applique un transform", "Désactive les transitions", "Crée un nouveau layer"], bonne: 0, lang: "CSS" },
//   { texte: "Quel code crée une grille responsive sans media query ?", choix: ["grid-template-columns:repeat(auto-fit,minmax(200px,1fr));", "grid:auto;", "columns:responsive;", "grid-auto:1fr;"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `counter-increment` en CSS ?", choix: ["Incrémente un compteur CSS personnalisé", "Compte les éléments", "Incrémente z-index", "Compte les animations"], bonne: 0, lang: "CSS" },
//   { texte: "Quel code numérote automatiquement les sections avec CSS ?", choix: ["counter-reset:sec; h2::before { counter-increment:sec; content:counter(sec)'. '; }", "numbering:auto;", "list:auto;", "h2:count{};"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `backdrop-filter: blur(10px);` ?", choix: ["Applique un flou derrière l'élément (effet verre)", "Flou sur l'élément", "Flou de l'ombre", "Flou du texte"], bonne: 0, lang: "CSS" },
//   { texte: "Quelle propriété définit l'ordre d'un item flex sans changer le HTML ?", choix: ["order", "z-index", "flex-order", "position"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `shape-outside: circle();` sur un élément flottant ?", choix: ["Le texte épouse la forme circulaire", "Crée un cercle CSS", "Clip l'élément", "Change le border-radius"], bonne: 0, lang: "CSS" },
//   { texte: "Quel code crée une barre de progression CSS pure à 70% ?", choix: ["width:70%; height:8px; background:green; dans un div conteneur", "progress:70%;", "bar:70;", "fill:70%;"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `appearance: none;` sur un <select> ?", choix: ["Supprime le style natif du navigateur", "Cache le select", "Désactive le select", "Supprime les options"], bonne: 0, lang: "CSS" },
//   { texte: "Quelle propriété CSS gère l'ordre visuel dans un grid sans toucher au DOM ?", choix: ["order", "tab-index", "grid-flow", "z-index"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `@supports (display: grid)` ?", choix: ["Applique les styles si grid est supporté", "Crée une grille", "Vérifie la version CSS", "Importe un module grid"], bonne: 0, lang: "CSS" },
//   { texte: "Quel code applique un style si la propriété `gap` est supportée ?", choix: ["@supports (gap: 1rem) { ... }", "@if supports gap { }", "@feature gap { }", "@compat(gap) { }"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `contain: strict;` ?", choix: ["Isole le rendu pour optimiser le navigateur", "Empêche les styles de sortir", "Fixe la taille", "Désactive les media queries"], bonne: 0, lang: "CSS" },
//   { texte: "Quel code crée un effet de carte qui se retourne au hover ?", choix: [".card:hover .inner { transform:rotateY(180deg); } avec perspective sur le parent", "rotate:hover 180;", "flip:true;", "animation:flip;"], bonne: 0, lang: "CSS" },
//   { texte: "Que fait `overscroll-behavior: contain;` ?", choix: ["Empêche le scroll de se propager au parent", "Contient l'élément", "Désactive le scroll", "Fixe le scroll"], bonne: 0, lang: "CSS" },
//   { texte: "Quel code crée un thème sombre via variables CSS sur un attribut data ?", choix: ["[data-theme='dark'] { --bg:#111; --text:#fff; }", "@dark { bg:#111; }", "theme.dark { bg:#111; }", "css-dark { --bg:#111; }"], bonne: 0, lang: "CSS" },
// ];
...
//       const reponse2 = await fetch('https://codeduel-backend-w2p6.onrender.com/api/joueurs/connexion', {
//       method: 'POST',
//   headers: { 'Content-Type': 'application/json' },
...
//     try {
//       const reponse = await fetch('https://codeduel-backend-w2p6.onrender.com/api/paiement/verifier/' + transactionId);
//       const data = await reponse.json();
//       if (data.approuve) {
...
socket.on('mise-a-jour-salle', (data) => {
  ...
  if (salleJoueurs) {
    salleJoueurs.innerHTML = data.joueurs.map(j =>
  ...
  if (salleNombre) {
    salleNombre.textContent = data.nombre + ' / ' + data.requis;
  }
...
// Compte à rebours de 5s avant lancement automatique
socket.on('lancement-imminent', (data) => {
  const compteEl = document.getElementById('compte-rebours');
  if (compteEl) {
    compteEl.textContent = `🚀 Lancement dans ${data.compte}s`;
    compteEl.style.color = data.compte <= 3 ? '#EC4899' : '#10B981';
  }
});

// Compte à rebours de 3s dans demarrerPartie
socket.on('compte-rebours', (data) => {
  const compteEl = document.getElementById('compte-rebours');
  if (compteEl) compteEl.textContent = data.compte;
});
...
socket.on('partie-terminee', (data) => {
  ...
  resultatEl.innerHTML =
    '<div class="resultat-titre">' + (estGagnant ? '🏆 Tu as gagné !' : '🎮 Partie terminée !') + '</div>' +
    '<div class="resultat-score">' + (estGagnant ? '+ 5000 FCFA 🤑' : score + ' pts') + '</div>' +
    '<div class="resultat-message">' + (estGagnant
      ? 'Félicitations ! Tu es le meilleur !'
      : 'Gagnant : ' + gagnant.nom + ' avec ' + gagnant.score + ' pts') + '</div>';
});
...
// Classement live pendant le jeu
socket.on('classement', (data) => {
  ...
  try {
    ...
    if (reponse.ok) {
      ...
      const reponse2 = await fetch('https://codeduel-backend-w2p6.onrender.com/api/joueurs/connexion', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ telephone, nom }) // ← nom inclus pour mise à jour
      });
      const data2 = await reponse2.json();
      if (data2.joueur) return data2.joueur;
      return null;
...
// ===================================================
function getClassementLocal() {
  return dernierClassement || [{ nom: joueurInfo ? joueurInfo.nom : 'Toi', score }];
}
...
function afficherResultat() {
  ...
  const pourcentage = Math.round((score / max) * 100);
  let emoji, message;
  if (pourcentage >= 80)      { emoji = '🏆'; message = 'Excellent ! Tu es un(e) pro du CSS !'; lancerConfettis(); lancerConfettis(); }
  else if (pourcentage >= 50) { emoji = '👏'; message = 'Bien joué ! Continue comme ça !'; }
  else                        { emoji = '💪'; message = 'Courage ! La pratique mène à la perfection !'; }
...
if (chatBtn)   chatBtn.addEventListener('click', envoyerMessage);
if (chatInput) chatInput.addEventListener('keypress', (e) => { if (e.key === 'Enter') envoyerMessage(); });
